...
function layout(element) {
  ...
  style.flexDirection = flexDirection === 'auto' ? 'row' : flexDirection
  style.alignItems = alignItems === 'auto' ? 'stretch' : alignItems
  style.justifyContent = justifyContent === 'auto' ? 'flex-start' : justifyContent
  style.flexWrap = flexWrap === 'auto' ? 'nowrap' : flexWrap
  style.alignContent = alignContent === 'auto' ? 'stretch' : alignContent
